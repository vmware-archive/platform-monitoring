...
public class JmxConnectorManager {
    ...
    public static JMXConnector getConnection() throws IOException {
        if(JmxConnectorManager.conn != null) {
            return JmxConnectorManager.conn;
        }
        ...
        JmxConnectorManager.conn = JMXConnectorFactory.connect(serviceURL, env);
        return conn;
    }

    public static void closeConnection() throws IOException {
        if(JmxConnectorManager.conn != null) {
            JmxConnectorManager.conn.close();
        }
    }
}
